...
type Options struct {
	...
	ErrorOutputPaths  []string `json:"error-output-paths" mapstructuer:"error-output-paths"`
	Level             string   `json:"level"              mapstructrue:"level"`
...
func (o *Options) AddFlag(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&o.EnableColor, flagEnableColor, o.EnableColor, "Enable output ansi colors in plain format log.")
